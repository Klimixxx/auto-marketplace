...
export default function Footer() {
  ...
  const link = (href, label) => (
    <a
      ...
      onMouseEnter={(e) => (e.currentTarget.style.color = UI.title)}
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "18px 12px" }}>
        ...
        >
          {/* ЛОГО / бренд */}
          <div
            style={{ textAlign: "center", marginTop: 6, alignSelf: "center" }}
          >
            <div
              style={{
                display: "inline-flex",
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              <a
                href="https://t.me/"
                aria-label="Telegram"
                style={iconWrap(UI, "rgba(34, 211, 238, .15)", "#22D3EE")}
              >
                <TelegramIcon />
              </a>
              <a
                ...
                style={iconWrap(UI, "rgba(236, 72, 153, .15)", "#E1306C")}
              >
                <InstagramIcon />
              </a>
              <a
                ...
                aria-label="YouTube"
                style={iconWrap(UI, "rgba(239, 68, 68, .15)", "#FF0000")}
              >
                <YoutubeIcon />
              </a>
            </div>
            <div style={{ color: UI.text, fontSize: 13.5, lineHeight: 1.6 }}>
              Тел.:{" "}
              <a href="tel:+79990000000" style={contactLinkStyle(UI)}>
                +7 (999) 000-00-00
              </a>
              <br />
              Почта:{" "}
              <a
                href="mailto:support@auctionafto.ru"
                style={contactLinkStyle(UI)}
              >
                support@auctionafto.ru
              </a>
            </div>
          </div>
          ...
          <div style={{ textAlign: "center", marginTop: 6 }}>
            ...
            <div style={{ color: UI.text, fontSize: 13.5, lineHeight: 1.65 }}>
              Адрес: г. Москва, ул. Пример, 1<br />© 2023—2025 «AuctionAfto»
            </div>
          </div>
        </div>
        ...
        >
          Данную платформу разработала студия —{" "}
          <strong style={{ color: UI.title }}>Timof</strong>
        </div>
      </div>
...
function TelegramIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        d="M21 3L3 11l6 2 2 6 3-4 5-12z"
        stroke="#22D3EE"
        strokeWidth="1.8"
...
function YoutubeIcon() {
  return (
    <svg width="24" height="17" viewBox="0 0 24 17" fill="none" aria-hidden>
      <path
        d="M23.2 3.1a3 3 0 00-2.1-2.1C19.3.5 12 .5 12 .5s-7.3 0-9.1.5A3 3 0 00.8 3.1C.3 5 .3 8.5.3 8.5s0 3.5.5 5.4a3 3 0 002.1 2.1c1.8.5 9.1.5 9.1.5s7.3 0 9.1-.5a3 3 0 002.1-2.1c.5-1.9.5-5.4.5-5.4s0-3.5-.5-5.4z"
        stroke="#FF0000"
        strokeWidth="1.3"
      />
