const EXACT_FIELD_LABELS = {
  ...
  deposit_percentage: 'Процент задатка',
  deposit_percent: 'Процент задатка',
  step: 'Шаг аукциона',
  auction_step: 'Шаг аукциона',
  price_step: 'Шаг снижения цены',
  currency: 'Валюта',
  tax: 'Налог',
  nds: 'НДС',
  region: 'Регион',
  ...
  manager_full_name: 'ФИО управляющего',
  ...
  trading_id: 'Номер торгов',
  trading_number: 'Номер торгов',
  ...
  bankruptcy_case: 'Номер дела о банкротстве',
  bankruptcy_case_number: 'Номер дела о банкротстве',
