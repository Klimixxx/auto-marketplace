        ...
        >
          ...
          <div style={{ position: 'relative', padding: 18 }}>
            ...
            <p style={{ margin: '0 0 16px', color: UI.text }}>
              Введите номер в формате <strong style={{ color: '#fff' }}>+7</strong> ХХХ ХХХ-ХХ-ХХ. Мы отправим код в&nbsp;SMS.
            </p>

            {/* ====== ШАГ 1: номер телефона ====== */}
            {step === 'phone' && (
              <form onSubmit={requestCode} style={{ display: 'grid', gap: 12, maxWidth: 520 }}>
                <div
                  style={{
                    background: 'rgba(255,255,255,0.06)',
                    border: `1px solid ${UI.border}`,
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 700,
                    border: 'none',
                    cursor: loading || phoneLocal.length !== 10 ? 'not-allowed' : 'pointer',
            ...
            {/* ====== ШАГ 2: код из SMS ====== */}
            {step === 'code' && (
              <form onSubmit={verifyCode} style={{ display: 'grid', gap: 12, maxWidth: 520 }}>
                <div
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
            ...
            {/* оферта/подсказка */}
            <p style={{ margin: '14px 0 0', color: 'rgba(255,255,255,0.6)', fontSize: 12.5, lineHeight: 1.5 }}>
